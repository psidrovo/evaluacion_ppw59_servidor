...
a persistence unit "paul_idrovo_servidorPersistenceUnit" which uses the JakartaEE default database.
...
In case you don't want to use JSF, simply delete this file and "src/main/webapp/beans.xml" and "src/main/java/ec/edu/ups/paul_idrovo_servidor/Jsf23Activator.java"
==========================

Testing:
This sample is prepared for running unit tests with the Arquillian framework.

The configuration can be found in "paul_idrovo_servidor/pom.xml":
...
artifact ("paul_idrovo_servidor.war") is already built. You can build
